  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full">
        ...
        />
        <p className="absolute top-[calc(45%+100px)] left-0 transform translate-x-4 w-full text-left text-2xl lg:text-3xl font-bold text-wrap z-10 pr-4">
          HECHO PARA AMANTES DEL SONIDO
        </p>
        <p className="absolute top-[calc(50%+100px)] left-0 transform translate-x-4 w-full text-left text-lg lg:text-2xl font-regular text-wrap z-10 pr-40">
      ...
      <div
        ...
        className="hidden md:flex flex-col columns-1 gap-6 justify-center items-center h-full xs:w-screen md:w-1/2 mt-[-50px]"
      >
        <p className="w-7/5 mx-auto text-center text-5xl font-bold text-wrap">
          ESPECIFICACIONES
        </p>
        <p className="w-7/5 px-4 text-left text-4xl font-bold text-wrap md:text-nowrap">
        <br />
